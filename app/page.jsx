...
const howItWorks = [
  { step: "Sign Up", description: "Create your free Calendso account" },
  {
    ...
    <main className="container mx-auto px-4 py-16">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-24">
        <div className="lg:w-1/2 ml-5 md:ml-20">
          ...
          <p className="text-xl text-gray-600 mb-10">
            Calendso helps you manage your time effectively. Create events, set
      ...
      <div className="bg-blue-600 text-white rounded-lg p-8 text-center">
        ...
        <p className="text-xl mb-6">
          Join thousands of professionals who trust Calendso for efficient time
          management.
        </p>
        <Link href={"/dashboard"}>
